...
var main = {
    ...
    hideLogoF: function() {
        "true" == hideLogo && $("img[src^='static/image/common/newlogo.png']").hide()
    },
    ...
    isLookF: function() {
        ...
        if (inZkdjt) {
            $(zkdjtPath + " tr th a.xst").each(function() {
                var a = $(this),
                    b = a.attr("href");
                if (b && -1 < b.indexOf("thread&tid=")) {
                    var c = b.substring(b.indexOf("thread&tid=") + 11, b.indexOf("&extra"));
                    (-1 < isLookTzid.indexOf("," + c + ",")) && (a.css("color", "#ccc"), a.css("backgroundColor", "transparent"), a.html(a.text()))
                }
...
$(function() {
    var a = location.href;
    (-1 < a.indexOf("new.php")) && (inZkzx = !0);
    (-1 < a.indexOf("forum-2") || -1 < a.indexOf("&fid=2")) && (inZkdjt = !0);
    if (inZkdjt || inZkzx, initCheckbox("isEditIcon", isEditIcon, function(a) {
        ...
        $("#threadlist .tf:first a.xi2:nth-child(6)").after("&nbsp;&nbsp;<a href=\"forum.php?mod=forumdisplay&fid=2&filter=author&orderby=dateline\" class=\"xi2\">\u53D1\u5E16\u65F6\u95F4</a>")
    }
});